...
|  18/12/2025 |  😀  | Product of Array Except Self | Solved with help, i had difficult to visualize the logic of left element X right element.The trick was using a variable start at 1, so the multiplication occurred with the elements, except the actual, making this for left and after, and after multiplying the elements of the left by the elements in the right|
<center>
